...
def get_args():
    ...
    parser.add_argument(
        '--print_examples', action='store_true', default=False)
    ...
    parser.add_argument(
        '--train_fpath', type=str, default='./data/slm/slm_train.json')
    parser.add_argument(
        '--eval_fpath', type=str, default='./data/slm/slm_validation.json')
    parser.add_argument(
        '--eval_split', type=str, default='dev', choices=['dev', 'test'])
    parser.add_argument(
        '--train_size', type=int, default=-1, help='size of train set. default: use full data')
